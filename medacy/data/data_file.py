...
class DataFile:
    ...
    file_name: the name of the file being represented
    txt_path: the text document corresponding to this file
    ann_path: the annotations of the text document
    metamapped_path: the metamap file
    """
