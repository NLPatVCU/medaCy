...
class BiLstmCrf(nn.Module):
    ...
    def _get_character_features(self, sentence):
        ...
        return self.character_lstm(character_indices)
    ...
    def _get_lstm_features(self, sentence):
        ...
        embedding_indices = torch.tensor([token[0] for token in sentence], device=self.device)
        ...
        other_features = torch.tensor([token[2:] for token in sentence], device=self.device)
